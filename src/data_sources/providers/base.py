...
import pandas as pd
import numpy as np
# Stub imports for missing src.data modules (trading_agent doesn't have these)
try:
    from src.data.stock_index_loader import get_index_stock_name
except ImportError:
    def get_index_stock_name(code: str) -> str:
        """Stub function - return empty string"""
        return ""
...
class StubConfig:
    """Stub config for compatibility with src.config"""
...
class DataFetcherManager:
    ...
    def _get_tickflow_fetcher(self):
        ...
        # Stub: trading_agent doesn't have src.config, return None
        return None
